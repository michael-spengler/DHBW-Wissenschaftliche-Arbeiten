...
5. Die Arbeit soll klar strukturiert und wie ein spannendes wissenschaftliches Buch zu lesen sein. Exkurs: "Storytelling PLUS Wissenschaft - victim, aggressor, hero, guide" --> Die Erkundung aus unterschiedlichen Perspektiven fördert dabei gleichzeitig die Ganzheitlichkeit Ihrer Arbeit. Nutzen Sie Diagramme (z.B. via [Math3D](https://www.math3d.org/) + Screenshots), arbeiten Sie insgesamt viel mit Bildern (ggf. zusätzlich in Form von Metaphern). Dadurch tragen Sie typischerweise dazu bei dass in Ihnen und bei Ihren Lesern schneller und nachhaltiger Klarheit entsteht.     
